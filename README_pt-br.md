...
Neste projeto foi desenvolvido um jogo no estilo Super Trunfo! Ao utilizar essa aplicação você será capaz de:
...
<details>
  <summary><strong>:memo: Minhas habilidades</strong></summary><br />
...
- Use o comando: `git clone git@github.com:lucasdximenes/tryunfo.git`.
